...
const t = {
  ...
  hero: {
    ...
    h1a: { en: "Your finance operations", es: "Sus operaciones financieras" },
    h1b: { en: "should run better.", es: "deberían funcionar mejor." },
    sub: { en: "I partner with CFOs and commercial leaders across Latin America to close the gap between messy data and clear decisions — through sharper reporting, tighter controls, and modern tools.", es: "Me asocio con CFOs y líderes comerciales en América Latina para cerrar la brecha entre datos desordenados y decisiones claras — con reportes más precisos, controles más sólidos y herramientas modernas." },
  ...
  tiles: {
    ...
    sub: { en: "Each tile is a working deliverable — not a description of what I could do, but proof of what I will do in your organization.", es: "Cada módulo es un entregable funcional — no una descripción de lo que podría hacer, sino prueba de lo que haré en su organización." },
    more: { en: "Learn more", es: "Ver más" },
  },
  evidence: {
    heading: { en: "The Proof Layer", es: "La Capa de Evidencia" },
    title: { en: "Don't Take My Word For It — Try It", es: "No Me Crea — Compruébelo Usted Mismo" },
  },
  about: {
    heading: { en: "About", es: "Sobre Mí" },
    title: { en: "German Precision. Panamanian Roots.", es: "Precisión Alemana. Raíces Panameñas." },
    p1: { en: "German-born finance professional with 20+ years inside multinational organizations across Latin America — managing P&Ls, building reporting systems, and running credit risk portfolios from the inside.", es: "Profesional financiero nacido en Alemania con más de 20 años dentro de organizaciones multinacionales en América Latina — gestionando P&Ls, construyendo sistemas de reportes y administrando portafolios de riesgo crediticio desde adentro." },
    p2: { en: "Married to a Panamanian, permanent resident, and member of the German-Panamanian Chamber of Commerce (AHK) and PMI Panama.", es: "Casado con panameña, residente permanente, y miembro de la Cámara de Comercio Alemana-Panameña (AHK) y PMI Panamá." },
    p3: { en: "Today I combine that operational depth with Power BI, AI workflow automation, and PMP-certified project methodology to deliver results faster than traditional approaches allow.", es: "Hoy combino esa profundidad operativa con Power BI, automatización de flujos con IA y metodología de proyectos PMP para entregar resultados más rápido que los enfoques tradicionales." },
    p4: { en: "I don't advise from the outside. I go in, find the gaps, and fix them.", es: "No asesoro desde afuera. Entro, encuentro las brechas y las corrijo." },
  },
  contact: {
    heading: { en: "Get in Touch", es: "Contáctame" },
    title: { en: "Let's discuss how I can help.", es: "Hablemos de cómo puedo ayudar." },
    sub: { en: "Finance business partner, project manager, or consultant — I'm ready to hit the ground running.", es: "Socio financiero, gerente de proyectos o consultor — estoy listo para empezar de inmediato." },
  },
  footer: {
...
function getTiles(lang: Lang): TileData[] {
  if (lang === "es") {
    return [
      { id: "health-check", icon: "🏥", tag: "Herramienta de Diagnóstico", title: "Chequeo de Salud Financiera", hook: "Autoevaluación de 10 preguntas. Descubra dónde están expuestas sus operaciones financieras.", evidence: "Tome una evaluación de 2 minutos y obtenga un puntaje instantáneo de madurez en Reportería, Riesgo y Automatización de Procesos. El mismo marco de diagnóstico que aplico en la primera semana de cualquier compromiso.", cta: "Tomar la Evaluación", href: "/health-check" },
      { id: "dashboard", icon: "📊", tag: "Dashboard en Vivo", title: "Demo Manual-a-Automatizado", hook: "Dashboard interactivo de Power BI reemplazando una consolidación Excel de 3 días.", evidence: "Un dashboard regional de P&L funcional: 5 países, 12 meses, con varianza de ingresos/margen/OPEX y descomposición Precio/Volumen/Mix. Filtre, profundice, explore — exactamente lo que entregaría en el Día 1.", cta: "Explorar el Dashboard", href: "/dashboard" },
      { id: "ai-cases", icon: "🤖", tag: "IA en Acción", title: "Casos de Estudio: IA para Finanzas", hook: "3 escenarios reales donde la IA eliminó horas de trabajo en finanzas.", evidence: "Análisis de contratos automatizado de 2 días a 15 minutos. Comentarios de varianza de 4 horas a solo revisión. QA de documentos de cumplimiento vía RAG. Cada uno con pruebas antes/después.", cta: "Ver Casos de Estudio", href: "/ai-cases" },
      { id: "blueprint", icon: "📋", tag: "Plan de Incorporación", title: "Plan 30-60-90 Días", hook: "Mi sistema para entrar al caos y producir orden — en 90 días.", evidence: "Tres fases: Diagnóstico → Estabilización → Optimización. Cada una con entregables concretos — no alineamiento estratégico vago, sino productos como 'mapa de procesos documentado para cierre mensual' y 'dashboard de Power BI reemplazando consolidación manual.'", cta: "Ver el Plan Completo", href: "/blueprint" },
      { id: "risk-map", icon: "🔥", tag: "Marco de Riesgo", title: "Mapa de Calor de Riesgo Panamá", hook: "Una página que muestra a su CFO dónde está expuesto — y dónde no.", evidence: "Una plantilla lista para usar cubriendo riesgo tributario/reportería, riesgo operacional y riesgo regulatorio para SEMs en Panamá. Puntaje de Impacto × Probabilidad, listo para briefings de gerencia regional.", cta: "Ver la Plantilla", href: "/risk-map" },
      { id: "knowledge-base", icon: "🧠", tag: "Agente de Conocimiento", title: "Base de Conocimiento Corporativa", hook: "Las políticas y SOPs de su equipo — consultables en segundos en vez de días.", evidence: "Un proof of concept funcional: un agente IA entrenado con documentación corporativa realista (manual de controles, checklists de cierre, políticas de aprobación). Escriba una pregunta, obtenga una respuesta específica con citas de fuentes. Pruébelo usted mismo.", cta: "Probar el Agente", href: "/knowledge-base" },
    ];
  }
  return [
    { id: "health-check", icon: "🏥", tag: "Diagnostic Tool", title: "Finance Health Check", hook: "10-question self-assessment. Find out where your finance operations are exposed.", evidence: "Take a 2-minute assessment and get an instant maturity score across Reporting, Risk, and Process Automation. The same diagnostic framework I apply in the first week of any new engagement.", cta: "Take the Assessment", href: "/health-check" },
    { id: "dashboard", icon: "📊", tag: "Live Dashboard", title: "Manual-to-Automated Demo", hook: "Interactive Power BI dashboard replacing a 3-day Excel consolidation.", evidence: "A working regional P&L dashboard: 5 countries, 12 months, with revenue/margin/OPEX variance and Price/Volume/Mix decomposition. Filter, drill down, explore — exactly what I'd deliver on Day 1.", cta: "Explore the Dashboard", href: "/dashboard" },
    { id: "ai-cases", icon: "🤖", tag: "AI in Action", title: "AI for Finance Case Studies", hook: "3 real scenarios where AI cut hours from finance workflows.", evidence: "Contract analysis automated from 2 days to 15 minutes. Variance commentary from 4 hours to review-only. Compliance document QA via RAG-based retrieval. Each with before/after proof.", cta: "View Case Studies", href: "/ai-cases" },
    { id: "blueprint", icon: "📋", tag: "Onboarding Plan", title: "30-60-90 Day Blueprint", hook: "My system for walking into chaos and producing order — in 90 days.", evidence: "Three phases: Diagnostic → Stabilization → Optimization. Each with concrete deliverables — not vague strategic alignment, but outputs like 'documented month-end close process map' and 'Power BI dashboard replacing manual consolidation.'", cta: "See the Full Plan", href: "/blueprint" },
    { id: "risk-map", icon: "🔥", tag: "Risk Framework", title: "Panama Risk Heat Map", hook: "One page that shows your CFO where you're exposed — and where you're not.", evidence: "A ready-to-use heat map template covering tax/reporting risk, operational risk, and regulatory compliance risk for Panama SEMs. Impact × Likelihood scoring, ready for regional management briefings.", cta: "View the Template", href: "/risk-map" },
    { id: "knowledge-base", icon: "🧠", tag: "Knowledge Agent", title: "Corporate Knowledge Base", hook: "Your team's policies and SOPs — queryable in seconds instead of days.", evidence: "A working proof of concept: an AI agent trained on realistic corporate documentation (controls manual, close checklists, approval policies). Type a question, get a specific answer with source citations. Try it yourself.", cta: "Try the Agent", href: "/knowledge-base" },
  ];
}
  ...
  return (
    <section className="relative min-h-[76vh] flex items-center overflow-hidden bg-gradient-to-br from-[#0F1923] via-[#0D2137] to-[#1A2A3A]">
      ...
      <div ref={f.ref} style={f.style} className="max-w-[1100px] mx-auto w-full grid grid-cols-1 md:grid-cols-[1fr_300px] gap-14 items-center px-6 pt-28 pb-10">
        <div>
          <div className="text-xs font-bold text-[#2EC4B6] tracking-[0.14em] uppercase mb-5">{t.hero.tag[lang]}</div>
        ...
        <div className="flex items-center justify-center gap-8 flex-wrap">
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center gap-10">
              ...
              <img src={PUIG_LOGO} alt="Puig" className="h-auto opacity-50 grayscale brightness-[1.8] hover:opacity-90 hover:grayscale-0 hover:brightness-100 transition-all duration-300" style={{ width: 70 }} />
            </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <img src={PMP_BADGE} alt="PMP Certified" className="h-auto hover:scale-105 transition-transform duration-300" style={{ width: 72 }} />
  ...
  return (
    <div ref={f.ref} style={f.style}>
      <div onClick={() => scrollTo(`ev-${tile.id}`)} className="bg-[#162230] border border-white/[0.06] rounded-xl p-7 cursor-pointer min-h-[220px] flex flex-col transition-all duration-250 hover:bg-[#1E3244] hover:border-[#2EC4B6]/[0.18] hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.3)] group">
        ...
        <p className="text-sm text-white/40 leading-relaxed flex-1">{tile.hook}</p>
        <div className="text-[13px] font-semibold text-[#2EC4B6] mt-4 flex items-center gap-1.5">{t.tiles.more[lang]} <span className="inline-block transition-transform group-hover:translate-x-1">↓</span></div>
      </div>
    </div>
  );
}
    ...
    <section id="tiles" className="py-24 px-6 bg-[#0F1923]">
      <div ref={f.ref} style={f.style} className="max-w-[1100px] mx-auto">
        <div className="text-center mb-14">
          <div className="text-xs font-bold text-[#2EC4B6] tracking-[0.14em] uppercase mb-2.5">{t.tiles.heading[lang]}</div>
...
function EvidenceSection({ lang }: { lang: Lang }) {
  ...
  return (
    <section id="evidence" className="py-24 px-6 bg-[#1A2A3A]">
      <div ref={f.ref} style={f.style} className="max-w-[1100px] mx-auto">
        <div className="text-center mb-14">
          <div className="text-xs font-bold text-[#2EC4B6] tracking-[0.14em] uppercase mb-2.5">{t.evidence.heading[lang]}</div>
  ...
  return (
    <section id="about" className="py-24 px-6 bg-[#0F1923]">
      <div ref={f.ref} style={f.style} className="max-w-[780px] mx-auto text-center">
        <div className="text-xs font-bold text-[#2EC4B6] tracking-[0.14em] uppercase mb-2.5">{t.about.heading[lang]}</div>
  ...
  return (
    <section id="contact" className="py-24 px-6 bg-[#162230] border-t border-white/[0.06]">
      <div ref={f.ref} style={f.style} className="max-w-[1100px] mx-auto text-center">
        <div className="text-xs font-bold text-[#2EC4B6] tracking-[0.14em] uppercase mb-2.5">{t.contact.heading[lang]}</div>
        <h2 className="text-3xl md:text-4xl font-bold text-[#F0F4F8] mb-3.5">{t.contact.title[lang]}</h2>
        <p className="text-base text-white/40 max-w-[480px] mx-auto mb-10 leading-relaxed">{t.contact.sub[lang]}</p>
          ...
          {channels.map((c, i) => (
            <a key={i} href={c.href} target={c.href.startsWith("http") ? "_blank" : undefined} rel="noreferrer" className="bg-[#1A2A3A] border border-white/[0.06] rounded-xl px-8 py-5 no-underline flex items-center gap-3.5 transition-all hover:border-[#2EC4B6]/[0.18] hover:bg-[#1E3244]">
              ...
              <div className="text-left">
                <div className="text-[11px] text-white/40 font-semibold tracking-wider uppercase mb-0.5">{c.label}</div>

...
function getTiles(lang: Lang): TileData[] {
  ...
  return [
    ...
    { id: "blueprint", icon: "📋", tag: "My Onboarding Approach", title: "How I Get Up to Speed", hook: "Three phases: Listen → Strengthen → Build. Each with clear outcomes.", evidence: "Three phases: Diagnostic → Stabilization → Optimization. Each with concrete deliverables. Here's what the first 90 days typically look like.", cta: "See the Full Plan", href: "/blueprint" },

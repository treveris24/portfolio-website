...
const t = {
  ...
  tiles: {
    ...
    sub: { en: "Each tile is a working deliverable — not a description of what I could do, but proof of what I can bring to a finance team.", es: "Cada módulo es un entregable funcional — no una descripción de lo que podría hacer, sino prueba de lo que puedo aportar a un equipo financiero." },
  ...
  about: {
    ...
    p1: { en: "German-born finance professional with 20+ years inside multinational organizations across Latin America — managing P&Ls, building reporting systems, and working with credit risk portfolios from the inside.", es: "Profesional financiero nacido en Alemania con más de 20 años dentro de organizaciones multinacionales en América Latina — gestionando P&Ls, construyendo sistemas de reportes y trabajando con portafolios de riesgo crediticio desde adentro." },
    ...
    p4: { en: "I prefer working from the inside — embedded in the team, close to the data, focused on making things run better.", es: "Prefiero trabajar desde adentro — integrado en el equipo, cerca de los datos, enfocado en hacer que las cosas funcionen mejor." },
  },
  contact: {
...
function getTiles(lang: Lang): TileData[] {
  if (lang === "es") {
    return [
      { id: "health-check", icon: "🏥", tag: "Herramienta de Diagnóstico", title: "Chequeo de Salud Financiera", hook: "Autoevaluación de 10 preguntas. Descubra dónde sus operaciones financieras podrían mejorar.", evidence: "Una evaluación rápida de las áreas comunes donde los equipos financieros pueden fortalecer sus operaciones.", cta: "Tomar la Evaluación", href: "/health-check" },
      { id: "dashboard", icon: "📊", tag: "Dashboard en Vivo", title: "Demo Manual-a-Automatizado", hook: "Dashboard interactivo de Power BI reemplazando una consolidación Excel de 3 días.", evidence: "Un dashboard regional de P&L funcional: 5 países, 12 meses, con varianza de ingresos/margen/OPEX y descomposición Precio/Volumen/Mix. Un ejemplo práctico de cómo se ven los datos regionales consolidados cuando se automatizan.", cta: "Explorar el Dashboard", href: "/dashboard" },
      ...
      { id: "blueprint", icon: "📋", tag: "Mi Enfoque de Incorporación", title: "Plan 30-60-90 Días", hook: "Un enfoque estructurado para integrarse rápidamente y entregar resultados en 90 días.", evidence: "Tres fases: Diagnóstico → Estabilización → Optimización. Cada una con entregables concretos. Así es como típicamente lucen los primeros 90 días.", cta: "Ver el Plan Completo", href: "/blueprint" },
      { id: "risk-map", icon: "🔥", tag: "Marco de Riesgo", title: "Mapa de Calor de Riesgo Panamá", hook: "Una vista práctica de áreas comunes de riesgo para subsidiarias multinacionales en Panamá.", evidence: "Una plantilla lista para usar cubriendo riesgo tributario/reportería, riesgo operacional y riesgo regulatorio para SEMs en Panamá. Puntaje de Impacto × Probabilidad, listo para briefings de gerencia.", cta: "Ver la Plantilla", href: "/risk-map" },
      { id: "knowledge-base", icon: "🧠", tag: "Agente de Conocimiento", title: "Base de Conocimiento Corporativa", hook: "Las políticas y SOPs del equipo — consultables en segundos en vez de días.", evidence: "Un proof of concept funcional: un agente IA entrenado con documentación corporativa realista. Un equipo financiero obtiene respuestas instantáneas y precisas de sus propios manuales de políticas — sin enviar correos a tres personas y esperar dos días.", cta: "Probar el Agente", href: "/knowledge-base" },
    ];
  }
  return [
    ...
    { id: "dashboard", icon: "📊", tag: "Live Dashboard", title: "Manual-to-Automated Demo", hook: "Interactive Power BI dashboard replacing a 3-day Excel consolidation.", evidence: "A working regional P&L dashboard: 5 countries, 12 months, with revenue/margin/OPEX variance and Price/Volume/Mix decomposition. A practical example of how consolidated regional data can look when automated.", cta: "Explore the Dashboard", href: "/dashboard" },
    ...
    { id: "blueprint", icon: "📋", tag: "My Onboarding Approach", title: "30-60-90 Day Plan", hook: "A structured approach to getting up to speed and delivering results in 90 days.", evidence: "Three phases: Diagnostic → Stabilization → Optimization. Each with concrete deliverables. Here's what the first 90 days typically look like.", cta: "See the Full Plan", href: "/blueprint" },
    { id: "risk-map", icon: "🔥", tag: "Risk Framework", title: "Panama Risk Heat Map", hook: "A practical overview of common risk areas for multinational subsidiaries in Panama.", evidence: "A ready-to-use heat map template covering tax/reporting risk, operational risk, and regulatory compliance risk for Panama SEMs. Impact × Likelihood scoring, ready for management briefings.", cta: "View the Template", href: "/risk-map" },
    { id: "knowledge-base", icon: "🧠", tag: "Knowledge Agent", title: "Corporate Knowledge Base", hook: "The team's policies and SOPs — queryable in seconds instead of days.", evidence: "A working proof of concept: an AI agent trained on realistic corporate documentation. A finance team gets instant, accurate answers from its own policy manuals, audit guidelines, and SOPs — no more emailing three people and waiting two days.", cta: "Try the Agent", href: "/knowledge-base" },
  ];
}

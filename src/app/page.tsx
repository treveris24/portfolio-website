...
const t = {
  ...
  about: {
    ...
    p1: { en: "German-born finance professional with deep experience inside multinational organizations across Latin America — working with P&Ls, helping build reporting systems, and supporting credit risk portfolios from the inside.", es: "Profesional financiero nacido en Alemania con más de 20 años dentro de organizaciones multinacionales en América Latina — gestionando P&Ls, construyendo sistemas de reportes y trabajando con portafolios de riesgo crediticio desde adentro." },
    ...
    p3: { en: "Today I combine that operational experience with Power BI, AI-assisted workflows, and PMP-based project practices to help teams improve reporting and processes in a pragmatic way.", es: "Hoy combino esa profundidad operativa con Power BI, automatización de flujos con IA y metodología de proyectos PMP para entregar resultados más rápido que los enfoques tradicionales." },
    p4: { en: "I like to work alongside existing teams, understand where they need support, and then quietly help close gaps in reporting, controls, or processes.", es: "Prefiero trabajar desde adentro — integrado en el equipo, cerca de los datos, enfocado en hacer que las cosas funcionen mejor." },
  },
  contact: {
...
function getTiles(lang: Lang): TileData[] {
  if (lang === "es") {
    return [
      ...
      { id: "risk-map", icon: "🔥", tag: "Marco de Riesgo", title: "Mapa de Calor de Riesgo Panamá", hook: "Una vista práctica de áreas comunes de riesgo para subsidiarias multinacionales en Panamá.", evidence: "Una plantilla lista para usar que cubre los principales riesgos de SEMs en Panamá, para uso en discusiones internas y reportes del equipo financiero.", cta: "Ver la Plantilla", href: "/risk-map" },
      { id: "knowledge-base", icon: "🧠", tag: "Agente de Conocimiento", title: "Base de Conocimiento Corporativa", hook: "Las políticas y SOPs del equipo — consultables en segundos en vez de días.", evidence: "Un proof of concept funcional: una base de conocimiento asistida por IA entrenada con documentación corporativa realista. Puede escribir una pregunta y ver el tipo de respuestas que esta herramienta podría ofrecer.", cta: "Probar el Agente", href: "/knowledge-base" },
    ];
  }
  return [
